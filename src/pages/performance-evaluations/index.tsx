...
export function PerformanceEvaluationListPage(props: PerformanceEvaluationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getPerformanceEvaluations({
        relations: ['user_performance_evaluation_user_idTouser', 'user_performance_evaluation_teamlead_idTouser'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'user_performance_evaluation_teamlead_idTouser',
          header: 'User Performance Evaluation Teamlead Id Touser',
          accessorKey: 'user_performance_evaluation_teamlead_idTouser',
          cell: ({ row: { original: record } }: any) => (
            <Link
              as={NextLink}
              onClick={(e) => e.stopPropagation()}
              href={`/users/view/${record.user_performance_evaluation_teamlead_idTouser?.id}`}
            >
              {record.user_performance_evaluation_teamlead_idTouser?.email}
            </Link>
          ),
        }
      : null,
