  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Tetz, your comprehensive HR Management system. Streamline employee data, manage vacations, track time, oversee payrolls, and conduct performance evaluations all in one central place."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Tetz, your comprehensive HR Management system. Streamline employee data, manage vacations, track time, oversee payrolls, and conduct performance evaluations all in one central place.`}
            </Text>
            <Box
